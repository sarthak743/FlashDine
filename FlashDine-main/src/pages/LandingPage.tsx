import { QrCode, ChefHat, Smartphone, Clock, CreditCard, ArrowRight, Printer, Zap, ChevronDown } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen relative overflow-hidden flex flex-col">
      ...
      <div className="flex justify-end items-center p-6 animate-fade-in">
        {/* Admin access moved to KDS - no link here */}
      </div>
      ...
      <div className="flex-1 flex flex-col items-center justify-center p-6 text-center">
        ...
        <div className="grid grid-cols-3 gap-4 mb-12 w-full max-w-2xl px-4">
          ...
          >
            ...
            <p className="text-zinc-500 text-xs leading-relaxed">GPay and PhonePe UPI supported</p>
          </div>
        </div>
